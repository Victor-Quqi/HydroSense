...
graph TD
    ...
    subgraph C [C. 12V Actuator System]
        ...
        subgraph C_DRIVERS [Level Shifters]
            C1 -- "<b>GPIO12</b>" --> C_D1(NPN Transistor<br>S8050);
            C3 -- "10kΩ Pull-up" --> C_D1;
            C_D1 -- "Out (0V/12V)" --> C4_PWM1((PWM1));
            C_D1 -- "GND" --> F1;

            C1 -- "<b>GPIO13</b>" --> C_D2(NPN Transistor<br>S8050);
            C3 -- "10kΩ Pull-up" --> C_D2;
    ...
    subgraph E [E. User Interface]
        C1 -- "CLK: <b>GPIO1</b><br>DT: <b>GPIO2</b><br>SW: <b>GPIO21</b>" --> E1(Rotary Encoder);
        E1 -- "GND" --> F1;
    ...
    subgraph G [G. System Monitoring]
        B1 -- " " --> G1{Voltage Divider<br>R1=1.1M, R2=230k<br>C=0.1uF};
        G1 -- "<b>GPIO7</b> (ADC Signal)" --> C1;
        G1 -- " " --> F1;
    end
```