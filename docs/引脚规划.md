...
| | **旋转编码器 按键** | **GPIO21** | GPIO21 | `RTC`, `ADC1_CH2` |
| | **模式开关 输入1** | **GPIO5** | GPIO5 | `RTC`, `ADC1_CH4` |
| | **模式开关 输入2** | **GPIO6** | GPIO6 | `RTC`, `ADC1_CH5` |
| **SPI总线** | **墨水屏 SCK (时钟)** | **GPIO40** | GPIO40 | `RTC`, `ADC1_CH4` |
| *(显示驱动)* | **墨水屏 MOSI (数据)** | **GPIO41** | GPIO41 | `RTC`, `ADC1_CH5` |
| | **墨水屏 CS (片选)** | **GPIO42** | GPIO42 | `RTC`, `ADC1_CH6` |
